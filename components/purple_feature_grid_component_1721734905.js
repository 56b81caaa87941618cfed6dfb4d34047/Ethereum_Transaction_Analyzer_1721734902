...
Vue.component("purple_feature_grid_component_1721734905", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the game with our advanced transaction monitoring system that tracks new Ethereum transactions in real-time, giving you a competitive edge.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Gain valuable insights into new transactions with our powerful analysis tools, which dissect transaction data to uncover patterns, trends, and potential opportunities.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Never miss a beat with our customizable alert system, which notifies you instantly when new transactions meeting your specified criteria occur.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Navigate our intuitive interface with ease, designed to provide a seamless experience for users of all skill levels.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Rest assured that your data is safe and your analysis is accurate, thanks to our robust security measures and reliable data sources.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Our platform is built to grow with your needs, ensuring that you have access to the latest technologies and features as the Ethereum ecosystem evolves.</p></div>
        </div>
    </div>`,
        data() {
            return {
